...
-- *Main> solve [[Let' 'b', Let' 'a', Zero], [Zero, Let' 'b', Let' 'a'], [Let' 'a', Zero, Let' 'b']] [Zero, One, Zero]
-- [Union' [Cat' [Star' (Let' 'b'),Let' 'a',Star' (Let' 'b')],Cat' [Star' (Let' 'b'),Let' 'a',Star' (Let' 'b'),
-- Let' 'a',Star' (Union' [Let' 'b',Cat' [Let' 'a',Star' (Let' 'b'),Let' 'a',Star' (Let' 'b'),Let' 'a']]),Let' 
-- 'a',Star' (Let' 'b'),Let' 'a',Star' (Let' 'b')]],Union' [Cat' [Star' (Let' 'b'),Let' 'a',
-- Star' (Union' [Let' 'b',Cat' [Let' 'a',Star' (Let' 'b'),Let' 'a',Star' (Let' 'b'),Let' 'a']]),
-- Let' 'a',Star' (Let' 'b'),Let' 'a',Star' (Let' 'b')],Star' (Let' 'b')],
-- Cat' [Star' (Union' [Let' 'b',Cat' [Let' 'a',Star' (Let' 'b'),Let' 'a',Star' (Let' 'b'),Let' 'a']]),Let' 'a',
-- Star' (Let' 'b'),Let' 'a',Star' (Let' 'b')]]
-- *Main> Compact (fromRE' (it !! 0))
-- b*ab*+b*ab*a(b+ab*ab*a)*ab*ab*
-- *Main> Compact (fromRE' (it !! 1))
-- b*a(b+ab*ab*a)*ab*ab*+b*
-- *Main> Compact (fromRE' (it !! 2))
-- (b+ab*ab*a)*ab*ab*
...
-- *Main> solve [[Let' 'a',Let' 'b'],[Let' 'b',Let' 'a']] [Zero,One]
...
-- ([[Let' 'b',Let' 'a',Zero,Zero],[Let' 'b',Zero,Let' 'a',Zero],[Zero,Zero,Let' 'a',Let' 'b'],
-- [Zero,Zero,Zero,Union' [Let' 'a',Let' 'b']]],[One,One,One,Zero])
-- *Main> solve [[Let' 'b',Let' 'a',Zero,Zero],[Let' 'b',Zero,Let' 'a',Zero],[Zero,Zero,Let' 'a', Let' 'b'],
-- [Zero,Zero,Zero,Union' [Let' 'a',Let' 'b']]] [One,One,One,Zero] 
-- [Union' [Cat' [Star' (Let' 'b'),Let' 'a',Star' (Cat' [Let' 'b',Star' (Let' 'b'),Let' 'a'])],
-- Cat' [Star' (Let' 'b'),Let' 'a',Star' (Cat' [Let' 'b',Star' (Let' 'b'),Let' 'a']),Let' 'a',Star' (Let' 'a')],
-- Cat' [Star' (Let' 'b'),Let' 'a',Star' (Cat' [Let' 'b',Star' (Let' 'b'),Let' 'a']),Let' 
-- 'b',Star' (Let' 'b')],Star' (Let' 'b')],Union' [Cat' [Star' (Cat' [Let' 
-- 'b',Star' (Let' 'b'),Let' 'a']),Let' 'a',Star' (Let' 'a')],Cat' [Star' (Cat' [Let' 'b',Star' (Let' 'b'),Let' 'a']),
-- Let' 'b',Star' (Let' 'b')],Star' (Cat' [Let' 'b',Star' (Let' 'b'),Let' 'a'])],Star' (Let' 'a'),Zero]
-- *Main> Compact (fromRE' (it !! 0))
-- b*a(bb*a)*+b*a(bb*a)*aa*+b*a(bb*a)*bb*+b*
-- *Main> Compact (fromRE' (it !! 1))
-- (bb*a)*aa*+(bb*a)*bb*+(bb*a)*
-- *Main> Compact (fromRE' (it !! 2))
-- a*     
-- *Main> Compact (fromRE' (it !! 3))
-- @
-- *Main> proper (conv avoid_aab)
-- False
...
-- *Main> solve [[Let' 'b',Let' 'a',Zero],[Zero,Let' 'a',Let' 'b'],[Let' 'b',Let' 'a',Zero]] [Zero,Zero,One]
-- [Cat' [Star' (Let' 'b'),Let' 'a',Star' (Let' 'a'),Let' 'b',Star' (Union' 
-- [Cat' [Let' 'a',Star' (Let' 'a'),Let' 'b'],Cat' [Let' 'b',Star' (Let' 'b'),Let' 'a',Star' (Let' 'a'),Let' 'b']])]
-- ,Cat' [Star' (Let' 'a'),Let' 'b',Star' (Union' [Cat' [Let' 'a',Star' (Let' 'a'),Let' 'b'],
-- Cat' [Let' 'b',Star' (Let' 'b'),Let' 'a',Star' (Let' 'a'),Let' 'b']])],Star' (Union' [Cat' [Let' 'a',Star' (Let' 'a'),
-- Let' 'b'],Cat' [Let' 'b',Star' (Let' 'b'),Let' 'a',Star' (Let' 'a'),Let' 'b']])]
-- *Main> Compact (fromRE' (it !! 0))
-- b*aa*b(aa*b+bb*aa*b)*
-- *Main> Compact (fromRE' (it !! 1))
-- a*b(aa*b+bb*aa*b)*
